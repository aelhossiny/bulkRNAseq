...
You can review this [tutorial](https://davetang.org/muse/2018/05/15/making-a-heatmap-in-r-with-the-pheatmap-package/) to learn how to customize the heatmap using [pheatmap](https://github.com/raivokolde/pheatmap) R package, including adding column and row annotations 
...
This is particularly beneficial when you have more than one level in the variable (e.g., WT, KO, DKO) and you want to have pairwise comparisons. Read more [here](https://www.r-bloggers.com/2024/05/a-guide-to-designs-and-contrasts-in-deseq2/)
